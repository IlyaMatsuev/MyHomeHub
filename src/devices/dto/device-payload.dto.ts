...
@ApiSchema({ name: 'Device.DevicePayload', description: 'DTO describing the structure of controls or measurements payloads' })
...
@ApiSchema({ name: 'Device.DeviceControls', description: 'DTO describing the structure of a generic controls payload' })
